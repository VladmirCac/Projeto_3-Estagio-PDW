...
<div class="modal" id="edicaoModal">
  <div class="modal-dialog">
    <div class="modal-content">
...
<div class="modal" id="remocaoModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="service/AutorService.php?passo=excluir" id="removAutor" method="post">
			...
			<label for="inputMax" class="col-sm-5 col-form-label">Autor à ser excluido:</label>
			    <div class="col-sm-10">
			     	<input type="text" class="form-control" id="inputRAutor" name="textRAutor" readonly="true" style="margin-bottom: 3%;">
			    </div>
			
			<label for="inputMax" class="col-sm-5 col-form-label">Autor à ser transferido:</label>	
			<div class="form-row align-items-center espacoForm">
		      	<div class="col-sm-9">
